...
<div className="flex row flex-wrap space-x-6">
    <IconAndText icon="/images/twitter.webp" href="https://twitter.com/k_shehadeh" text="Twitter"/>
    <IconAndText icon="/images/github.png" href="https://github.com/kshehadeh" text="Github"/>
    <IconAndText icon="/images/stackoverflow.png" href="https://stackoverflow.com/users/2494/karim" text="StackOverflow"/>
    <IconAndText icon="/images/linkedin.png" href="https://www.linkedin.com/in/karimshehadeh/" text="LinkedIn"/>
    <IconAndText icon="/images/docs.webp" href="https://docs.google.com/document/d/1teujRxoF3wpb4o9rQndcc8jdS3bpjKVI/edit?usp=sharing&ouid=116007903546684880246&rtpof=true&sd=true" text="Resume"/>
</div>